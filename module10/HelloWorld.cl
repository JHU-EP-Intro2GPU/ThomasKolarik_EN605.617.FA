...
// A kernal for "oring" the values in a and b into result.
...
// A kernal for "anding" the values in a and b into result.
...
// A kernal for "exclusing oring" the values in a and b into result.
