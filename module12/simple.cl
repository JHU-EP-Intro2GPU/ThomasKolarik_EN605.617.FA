...
__kernel void average(const __global float * subBuffer, __global float * outputBuffer, const int curSubbuffer, const int size)
{
	...
	outputBuffer[id + curSubbuffer * size] = average;
}